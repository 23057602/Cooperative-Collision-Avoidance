...
#include <dijkstra_collision_avoidance/Map_subscriber.hpp>
...
{
    public:
        explicit LocalPlanner(): Node("Dijkstra_avoidance_planner"), Map_subscriber("Dijkstra_avoidance_planner"), ForeBroadcaster("Dijkstra_avoidance_planner")
        {
            RCLCPP_INFO(this->get_logger(), "The Dijkstra Avoidance Planner has started. Initialising...");
            //get parameters
            ...
            this->declare_parameter("steering_limit", 0.7854);
            this->get_parameter("steering_limit", vehicle_steering_limit);
            this->declare_parameter("top_speed", 1.0);
            this->get_parameter("top_speed", fast);
            this->declare_parameter("crawl_speed", 0.5);
            this->get_parameter("crawl_speed", slow);
            //setup
