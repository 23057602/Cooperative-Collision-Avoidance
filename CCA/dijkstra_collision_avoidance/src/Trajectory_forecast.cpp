...
public:
    explicit Scout(): Node("Trajectory_forecast"), ForeBroadcaster("Trajectory_forecast")
    {
        RCLCPP_INFO(this->get_logger(), "The Trajectory Forecast Node has started. Initialising node...");
        ...
        this->get_parameter("top_speed", v_hi);
        this->declare_parameter("crawl_speed", 0.01);
        this->get_parameter("crawl_speed", v_lo);
